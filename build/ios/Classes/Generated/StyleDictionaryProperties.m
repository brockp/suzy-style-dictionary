...
// Generated on Wed, 07 Sep 2022 19:58:10 GMT
//
...
+ (NSDictionary *)properties {
  ...
  @"tokenSetOrder": @{
    ...
    @"16": @{
      @"value": Desktop,
      @"name": @"StyleDictionaryTokenSetOrder16",
      @"category": @"tokenSetOrder",
      @"type": @"16"
      },
    @"17": @{
      @"value": Tablet,
      @"name": @"StyleDictionaryTokenSetOrder17",
      @"category": @"tokenSetOrder",
      @"type": @"17"
      },
    @"18": @{
      @"value": Mobile,
      @"name": @"StyleDictionaryTokenSetOrder18",
      @"category": @"tokenSetOrder",
      @"type": @"18"
      },
    @"19": @{
      @"value": textCase,
      @"name": @"StyleDictionaryTokenSetOrder19",
      @"category": @"tokenSetOrder",
      @"type": @"19"
      },
    @"20": @{
      @"value": textDecoration,
      @"name": @"StyleDictionaryTokenSetOrder20",
      @"category": @"tokenSetOrder",
      @"type": @"20"
      }
    },
  ...
  @"quicksand-0": @{
    @"value": Bold,
    @"name": @"StyleDictionaryQuicksand0",
    @"category": @"quicksand-0"
    },
  @"quicksand-1": @{
    @"value": SemiBold,
    @"name": @"StyleDictionaryQuicksand1",
    @"category": @"quicksand-1"
    },
  @"quicksand-2": @{
    @"value": Medium,
    @"name": @"StyleDictionaryQuicksand2",
