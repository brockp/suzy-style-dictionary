...
+ (NSDictionary *)properties {
  ...
  @"lineHeights": @{
    @"150": @{
      @"value": 150%,
      @"name": @"StyleDictionaryLineHeights150",
      @"category": @"lineHeights",
      @"type": @"150"
      },
    @"default": @{
      @"value": 130%,
      @"name": @"StyleDictionaryLineHeightsDefault",
      @"category": @"lineHeights",
      @"type": @"default"
      }
    },
  ...
  @"fontSize": @{
    ...
    @"h3": @{
      @"value": 18,
      @"name": @"StyleDictionaryFontSizeH3",
      @"category": @"fontSize",
      @"type": @"h3"
      },
    @"h2": @{
      @"value": 20,
      @"name": @"StyleDictionaryFontSizeH2",
      @"category": @"fontSize",
      @"type": @"h2"
      },
    @"h1": @{
      @"value": 24,
      @"name": @"StyleDictionaryFontSizeH1",
      @"category": @"fontSize",
      @"type": @"h1"
      },
    @"h1-desktop": @{
      @"value": 32,
      @"name": @"StyleDictionaryFontSizeH1Desktop",
      @"category": @"fontSize",
      @"type": @"h1-desktop"
      }
    },
  ...
  @"icon": @{
    @"height": @{
      @"small": @{
        @"value": 16,
        @"name": @"StyleDictionaryIconHeightSmall",
        @"category": @"icon",
        @"type": @"height",
        @"item": @"small"
        },
      @"default": @{
        @"value": 24,
        @"name": @"StyleDictionaryIconHeightDefault",
        @"category": @"icon",
        @"type": @"height",
        @"item": @"default"
        },
      @"large": @{
        @"value": 40,
        @"name": @"StyleDictionaryIconHeightLarge",
        @"category": @"icon",
        @"type": @"height",
        @"item": @"large"
        },
      @"extra-large": @{
        @"value": 56,
        @"name": @"StyleDictionaryIconHeightExtraLarge",
        @"category": @"icon",
        @"type": @"height",
        @"item": @"extra-large"
        }
  ...
  @"button": @{
    @"default": @{
      @"background-color": @{
        @"value": #3589f9,
        @"name": @"StyleDictionaryButtonDefaultBackgroundColor",
        @"category": @"button",
        @"type": @"default",
      ...
      @"border-radius": @{
        @"value": 100,
        @"name": @"StyleDictionaryButtonDefaultBorderRadius",
        @"category": @"button",
        @"type": @"default",
        @"item": @"border-radius"
        },
      @"font-weight": @{
        @"value": Bold,
        @"name": @"StyleDictionaryButtonDefaultFontWeight",
        @"category": @"button",
        @"type": @"default",
        @"item": @"font-weight"
        },
      @"font-size": @{
        @"value": 14,
        @"name": @"StyleDictionaryButtonDefaultFontSize",
        @"category": @"button",
        @"type": @"default",
        @"item": @"font-size"
        },
      @"line-height": @{
        @"value": 150%,
        @"name": @"StyleDictionaryButtonDefaultLineHeight",
        @"category": @"button",
        @"type": @"default",
        @"item": @"line-height"
        },
      @"horizontal-padding": @{
        @"value": 32,
        @"name": @"StyleDictionaryButtonDefaultHorizontalPadding",
        @"category": @"button",
        @"type": @"default",
      ...
      @"vertical-padding": @{
        @"value": 16,
        @"name": @"StyleDictionaryButtonDefaultVerticalPadding",
        @"category": @"button",
        @"type": @"default",
    ...
    @"hover": @{
      @"background-color": @{
        @"value": #1e6fdb,
        @"name": @"StyleDictionaryButtonHoverBackgroundColor",
        @"category": @"button",
        @"type": @"hover",
        @"item": @"background-color"
        }
    ...
    @"pressed": @{
      @"background-color": @{
        @"value": #105EC6,
        @"name": @"StyleDictionaryButtonPressedBackgroundColor",
        @"category": @"button",
        @"type": @"pressed",
        @"item": @"background-color"
        }
    ...
    @"disabled": @{
      @"background-color": @{
        @"value": #24232B,
        @"name": @"StyleDictionaryButtonDisabledBackgroundColor",
        @"category": @"button",
        @"type": @"disabled",
        @"item": @"background-color"
        }
    ...
    @"focus": @{
      @"background-color": @{
        @"value": #C1CFE6,
        @"name": @"StyleDictionaryButtonFocusBackgroundColor",
        @"category": @"button",
        @"type": @"focus",
        @"item": @"background-color"
        },
      @"border-width": @{
        @"value": 2,
        @"name": @"StyleDictionaryButtonFocusBorderWidth",
        @"category": @"button",
        @"type": @"focus",
        @"item": @"border-width"
        },
      @"border-color": @{
        @"value": #1E6FDB,
        @"name": @"StyleDictionaryButtonFocusBorderColor",
        @"category": @"button",
        @"type": @"focus",
        @"item": @"border-color"
        }
